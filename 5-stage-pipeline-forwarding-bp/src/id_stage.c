...
void id_stage(void) {
    ...
    ex_state.br_pred_taken = id_state.br_pred_taken;
    ex_state.br_pred_delayed = id_state.br_pred_delayed;
    ex_state.br_pred_target = id_state.br_pred_target;
    ...
    case 0x2E: // BRI, BRLI, BRAI, BRALI, BRID, BRLID, BRAID, BRALID
    {
        ...
        ex_state.branch_delayed = br_delay;
        msr.i = 0;
    ...
    case 0x2F: // BEQI, BNEI, BLTI, BLEI, BGTI, BGEI, BEQID, BNEID, BLTID, BLEID, BGTID, BGEID
    {
        ...
        ex_state.branch_delayed = br_cond_delay;
        msr.i = 0;
